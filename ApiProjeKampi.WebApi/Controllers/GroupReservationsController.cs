...
namespace ApiProjeKampi.WebApi.Controllers
{
    ...
    public class GroupReservationsController : ControllerBase
    {
        ...
        public IActionResult GroupReservationList()
        {
            ...
            return Ok(_mapper.Map<List<ApiProjeKampi.WebApi.Dtos.GroupReservationDtos.ResultGroupReservationDto>>(values));
        }
        [HttpPost]
        public IActionResult CreateGroupReservation([FromBody] CreateGroupReservationDto createGroupReservationDto)
        {
        ...
        {
            var value = _context.GroupReservations.Find(id);
            return Ok(_mapper.Map<GetGroupReservationByIdDto>(value));
        }
        [HttpPut]
